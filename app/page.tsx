        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="text-white text-sm space-y-3">
              ...
              <li className="pt-2">
                <a 
                  href="https://www.facebook.com/share/1ArB6cRu9A/?mibextid=wwXIfr" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-lg transition-all"
                >
