    ...
    <div className="max-w-5xl mx-auto py-12 px-6">
      ...
      <div className="grid md:grid-cols-2 gap-10">
        <div className="rounded-2xl overflow-hidden shadow-xl h-[400px]">
          <img src="https://finterior.com.vn/wp-content/uploads/2024/07/mau-thiet-ke-spa-thu-cung.jpg" className="w-full h-full object-cover" />
        </div>
        <div className="space-y-6">
          <div className="inline-block bg-yellow-100 text-yellow-700 font-bold px-4 py-1 rounded-full text-sm uppercase">Pet Care</div>
